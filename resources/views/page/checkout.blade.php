          ...
          @endif
            ...
            <div class="cart-information">
                <div class="your-order">
                        ...
                        <div class="your-order-item">
                            ...
                            <div class="media">
                                <img src="source/image/{{$product['item']['url_img']}}" alt=""
                                    class="img-product-checkout">
                                <div class="media-body">
                                    <p class="font-large">{{$product['item']['prod_name']}}</p>
                                    <span class="color-gray your-order-info">Số lượng: {{$product['quantity']}}</span>
                                </div>
                                <!-- end one item -->
                            </div>
                    ...
                    <div class="text-center btn-buy-now "><button type="submit" class="btn">Thanh toán <i
