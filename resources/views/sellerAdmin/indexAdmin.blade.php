    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Sellers</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{$seller_count}}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="chart-area">
                        ...
                        <canvas id="myAreaChart" style="display: block; width: 824px; height: 320px;" width="824"
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="chart-pie pt-4 pb-2">
                        ...
                        <canvas id="myPieChart" width="379" height="245" class="chartjs-render-monitor"
                            style="display: block; width: 379px; height: 245px;"></canvas>
                    </div>
