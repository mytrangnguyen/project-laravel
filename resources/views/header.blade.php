  ...
  <div class="container header-top">
    <div class="header-left">
      <div class="header-contact-email">
        <span><i class="fa-icon fa fa-envelope"></i></span><a class="icon-header link" href="mailto:hdflash@gmail.com"
          target="_top">hdflash@gmail.com</a>
      </div>
    ...
    <div class="header-right">
      ...
      <div class="avatar">
        <div class="user"><span><i class="fa fa-user" aria-hidden="true"></i></span><a class="icon-header link"
            id="login-button" href="{{route('users.edit',Auth::user())}}" target="_top">{{Auth::user()->username}}</a>
          &emsp;

        </div>
        <div class="logout"><span><i class="fa fa-sign-out" aria-hidden="true"></i></span><a href="{{route('logout')}}"
            class="icon-header  link" id="login-button" target="_top">Đăng
            xuất</a></div>
      ...
      <div class="register">
        <span><i class="fa-icon fa fa-envelope"></i></span><a class=" icon-header link" href="{{route('dangky')}}"
