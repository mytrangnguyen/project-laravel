            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="{{URL::action('PageAdminController@showAdminPage')}}">
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" name="txtemail" placeholder="Enter Email Address...">
                    </div>
                    <div class="form-group">
