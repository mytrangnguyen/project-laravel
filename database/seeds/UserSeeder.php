...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('users')->insert([
            ...
            'phone'=>'0134514542','user_role'=>'seller','avatar'=>'null','password'=>'111111'],
            ['username' => 'Nguyen Thi Mơ','email'=>'center1@gmail.com','address'=>'Da Nang',
            'phone'=>'0134514544','user_role'=>'seller','avatar'=>'null','password'=>'111111'],
            ['username' => 'Trần Minh Trí','email'=>'center2@gmail.com','address'=>'Da Nang',
            'phone'=>'0134514562','user_role'=>'seller','avatar'=>'null','password'=>'111111'],
            ['username' => 'Nguyễn Thiện Chí','email'=>'center3@gmail.com','address'=>'Da Nang',
            'phone'=>'0134714542','user_role'=>'seller','avatar'=>'null','password'=>'111111'],
            ['username' => 'Trần Hồng Sơn','email'=>'center4@gmail.com','address'=>'Da Nang',
            'phone'=>'0164514542','user_role'=>'seller','avatar'=>'null','password'=>'111111']
