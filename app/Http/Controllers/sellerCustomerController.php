...
class sellerCustomerController extends Controller
{
    public function getAddCustomer() {
    	return view('sellerAdmin.customer.add');
    }
    ...
    public function postAddCustomer(Request $request) {
		...
		$customer->save();
		return redirect()->route('sellerAdmin.customer.getListCustomer');
    }

    // show list Customer
    public function getListCustomer() {
        $customer = Customer::select('id','name','gender','email','address','note','phone_number')->get()->toArray();
        return view('sellerAdmin.customer.list',compact('customer'));
      }
    ...
    public function getEditCustomer($id) {
        ...
        return view('sellerAdmin.customer.edit',compact('customer'));
    }
    ...
    public function postEditCustomer($id,Request $request) {
        ...
        $customer->phone_number = $request->input('txtphone_number');
		    $customer->save();
        return redirect()->route('sellerAdmin.customer.getListCustomer')->with('success','Update successfully!');
      }
